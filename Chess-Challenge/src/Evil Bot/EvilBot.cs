...
{
    // First bot submission, a basic alphabeta search
    public class EvilBot : IChessBot
    {
        ...
        public Move Think(Board board, Timer timer)
        {
            ...
            Console.WriteLine($"EVIL Searched {moveCount} moves in {timer.MillisecondsElapsedThisTurn} ms- Chose {moveToPlay} new score -> {bestScore}, expecting {expected_response}");
            return moveToPlay;
        }
    }
}